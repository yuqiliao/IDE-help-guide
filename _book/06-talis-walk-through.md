...
**Dependent Variable,** and **Jurisdiction** for the data you wish to view or
...
### Choose Year(s)
To the right of the **Dependent Variable** and **Jurisdiction** tab titles, you
...
choose a **Dependent Variable** within the **Select Criteria** tab. Note that the
...
among a number of continuous variables listed under Dependent Variable. You can
...
use as a **Dependent Variable** in your analysis.
...
variable selections at any time by clicking **Select Grouping Variables**.

Exhibit 6-4. Select grouping variables overview
![Exhibit 6-4 is a screenshot from the TALIS IDE tool showing an overview of the Select Grouping Variables tab.](images/chapter6/image3.png){width="6.5in" height="4.478472222222222in"}

### Select Grouping Variables using Category and Sub Category Lists
On the **Select Grouping Variables** screen, choose at least one independent
...
(displayed as the default independent variable on the Select Grouping Variables
screen).

The variables shown are tied to the criteria you selected at step 1
(**Subject, Education Level**, **Dependent Variable, Year,** and **Jurisdiction**),
...
Exhibit 6-6. Select grouping variables using the search function
...
you have selected more than one **Dependent Variable** (e.g., a continuous variable
from step 1, **Select Criteria**), a separate set of data reports will
be generated for each **Dependent Variable**.
...
-   The **Dependent Variable** column shows which dependent variable the report will portray.

-   The **Grouping Variable** column indicates the variable(s) included in the
...
select **Create new...** under **Grouping Variable** (see exhibit 6-9). The new
...
The new variable will appear in the **Grouping Variable** list in the **Edit
...
For example, if you selected multiple dependent variables of teacher and principal
characteristics for analysis, then you would need to create the new
variable for *each* dependent variable or create a copy of the report and edit it
...
**Select Grouping Variables** and step 3, **Edit Reports** where you can select
...
variable for a single jurisdiction. Once the primary criterion is chosen, all other criteria must
