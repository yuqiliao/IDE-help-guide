...
<img src="images/chapter3/four-steps.png" width="50%" style="display: block; margin: auto;" />
...
Exhibit 2. Select criteria

![](images/chapter3/image2.png){width="6.5in" height="5.289788932633421in"}
...
default (as shown in exhibit 2). The 2001 and 2006 reading subscales
...
that you may choose as a measure (see exhibit 3). These variables---such
...
![](images/chapter3/image3.png){width="6.5in" height="5.289788932633421in"}
...
![](images/chapter3/image4.png){width="6.5in" height="5.289788932633421in"}
...
**Search** function (see exhibit 5). You can return to this screen to
change variable selections at any time.

Exhibit 5. Selecting variables overview

![](images/chapter3/image5.png){width="6.5in" height="5.289788932633421in"}
...
7.  Click **details** or **hide details** to show or hide the full title
    ...
    example in exhibit 6, which shows general things in the student's
...
Exhibit 6. Select variables using category and subcategory lists

![](images/chapter3/image6.png){width="6.5in" height="5.289788932633421in"}
...
![](images/chapter3/image7.png){width="6.5in" height="5.289788932633421in"}
...
(see exhibit 8, page 14).

Exhibit 8. Edit reports overview

![](images/chapter3/image8.png){width="6.5in" height="5.289788932633421in"}

The **Edit Reports** step shows detailed information on the layout of
your reports (see exhibit 8). The **Report** column indicates the
...
will be laid out (see exhibit 8). The preview will not provide actual
data, but will show how the data will be arranged in rows and columns
(see exhibit 9, page 15). You can select **Preview** at any time to see
how your changes will affect the report's final layout.

Exhibit 9. Using preview report

![](images/chapter3/image9.png){width="6.5in" height="5.289788932633421in"}

### 3.C. Edit Report

To edit the report, select the command under the **Action** column next
to the report (see exhibit 8 above). Another way to edit a report is to
select the **Edit** tab when you are previewing a report. The following
can be done using this function (see exhibit 10).

Exhibit 10. Editing reports

![](images/chapter3/image10.png){width="6.5in" height="5.289788932633421in"}
...
and select **Create new...** under **Variable** (see exhibit 10). The
...
![](images/chapter3/image11.png){width="6.5in" height="5.289788932633421in"}
...
12). You can click **Preview** to see how the table will be laid out
before retrieving data.

Exhibit 12. Edit report with collapsed variables

![](images/chapter3/image12.png){width="6.5in" height="5.289788932633421in"}
...
![](images/chapter3/image13.png){width="6.5in" height="5.289788932633421in"}
...
![](images/chapter3/image14.png){width="6.5in" height="5.289788932633421in"}
...
![](images/chapter3/image15.png){width="6.5in" height="5.289788932633421in"}
...
the example that follows (see exhibit 16), data will be retrieved only
for the combined reading measure.

Exhibit 16. Selecting reports to build

![](images/chapter3/image16.png){width="6.5in" height="5.289788932633421in"}
...
1.  Generate a data table for each report selected in step 3, as shown
    by the **Select Reports** drop-down feature (see 1 in exhibit 17).
...
Exhibit 17. Building reports overview ![](images/chapter3/image17.png){width="6.5in" height="5.289788932633421in"}

### 4.B. View Reports as Data Tables

Once you click on **Build Reports,** the words "Processing Data" will
appear on your screen (see exhibit 17). Some reports will take longer
...
(see 1 in exhibit 17) and choose a table of interest. Your table will
appear once the processing is complete (see exhibit 18). To change the
...
Exhibit 18. Viewing reports as data tables

![](images/chapter3/image18.png){width="6.5in" height="5.289788932633421in"}

### 4.C. Charts

Go to **Select Report** to choose the report of interest from the
drop-down menu, and then click the **Chart** link (see exhibit 19).
...
![](images/chapter3/image19.png){width="6.5in" height="5.289788932633421in"}[]{#_Toc257706705 .anchor}
...
exhibit 20). Uncheck any of the criteria that you do not wish to chart,
...
![](images/chapter3/image20.png){width="6.5in" height="5.289788932633421in"}

### 4.E. Create Charts---Chart Options

On the Chart Options screen, select **Bar Chart, Column Chart,** or
**Line Chart** (see exhibit 21). For data on achievement levels, you
...
Exhibit 21. Chart options ![](images/chapter3/image21.png){width="6.5in" height="5.289788932633421in"}

While previewing your chart, you can do the following (see exhibit 22 as
an example of a **Discrete Chart** and exhibit 23 as an example of a
**Bar Chart**):
...
2.  For the **Discrete Chart,** you can select where you want the
    ...
    level(s). In the example shown in exhibit 22, the percentages of
...
Exhibit 22. Preview of discrete chart

![](images/chapter3/image22.png){width="6.5in" height="5.289788932633421in"}

Exhibit 23. Preview of bar chart

![](images/chapter3/image23.png){width="6.5in" height="5.289788932633421in"}
...
exhibit 24). You can subsequently **"Click here to edit this chart"**
...
![](images/chapter3/image24.png){width="6.5in" height="5.289788932633421in"}
...
24, above). You first need to decide which variable you want to test and
...
shown in exhibit 25, you could choose to compare female scores between
...
Exhibit 25. Significance test options

![](images/chapter3/image25.png){width="6.5in" height="5.289788932633421in"}
...
exhibit 26). In the PIRLS IDE, most comparisons are independent with an
...
Exhibit 26. Significance test table output

![](images/chapter3/image26.png){width="6.5in" height="5.289788932633421in"}

When the map option is selected, a global map is shown with the
countries selected shaded (see exhibit 27). The focal jurisdiction is
...
Exhibit 27. Significance test map output

![](images/chapter3/image27.png){width="6.5in" height="5.289788932633421in"}
...
**Exhibit 28. Gap analysis link selection**

![](images/chapter3/image28.png){width="6.5in" height="5.289788932633421in"}
...
(see exhibit 28). You will need to decide which variable you would like
...
**Exhibit 29. Gap analysis options**

![](images/chapter3/image29.png){width="6.5in" height="5.289788932633421in"}

The steps for running a gap analysis are similar to those for conducting
a statistical significance test (see exhibit 29). Thus, to run a gap
...
differences just like in a significance test. For example, exhibit 30
...
**Exhibit 30. Gap analysis output**

![](images/chapter3/image30.png){width="6.5in" height="5.289788932633421in"}
...
the **Gap Analysis** link (see exhibit 31).

**Exhibit 31. Regression analysis link selection**

![](images/chapter3/image31.png){width="6.5in" height="5.289788932633421in"}
...
**Exhibit 32: Regression analysis options**

![](images/chapter3/image32.png){width="6.5in" height="5.289788932633421in"}

After you have clicked **Done**, your regression analysis output will
load onto the screen (see exhibit 33). A 0-1 contrast coding is used to
...
reference group. For example, in exhibit 33, if the subgroup \"Like
...
**Exhibit 33. Regression analysis output**

![](images/chapter3/image33.png){width="6.5in" height="5.289788932633421in"}

Using the output from exhibit 33 you can compare the mean reading score
...
**HTML** (print-friendly), **Excel, Word,** or **PDF** (see exhibit 34).
...
Exhibit 34. Export report options

![](images/chapter3/image34.png){width="6.5in" height="5.289788932633421in"}
