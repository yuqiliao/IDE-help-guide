...
```{r chapter1-1, echo=FALSE, fig.align='center', out.width="70%"}
knitr::include_graphics('images/chapter1/landing-page.png')
```
...
```{r chapter1-2, echo=FALSE, fig.align='center', out.width="50%"}
knitr::include_graphics('images/chapter1/user-agreement.png')
```
