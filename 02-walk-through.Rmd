...
```{r chapter2-1, echo=FALSE, fig.align='center', out.width="50%"}
knitr::include_graphics('images/chapter2/four-steps.png')
```
...
```{r chapter2-2, echo=FALSE, fig.align='center', out.width="90%"}
knitr::include_graphics('images/chapter2/choosing-jurisdictions.png')
```
